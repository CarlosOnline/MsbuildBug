...
namespace Vlc.DotNet.Forms
{
    public partial class VlcControl
    {
        ...
        {
            _vlcMediaPlayer.Backward += OnBackwardInternal;
            _vlcMediaPlayer.Buffering += OnBufferingInternal;
            _vlcMediaPlayer.EncounteredError += OnEncounteredErrorInternal;
            _vlcMediaPlayer.EndReached += OnEndReachedInternal;
            _vlcMediaPlayer.Forward += OnForwardInternal;
            _vlcMediaPlayer.LengthChanged += OnLengthChangedInternal;
            _vlcMediaPlayer.MediaChanged += OnMediaChangedInternal;
            _vlcMediaPlayer.Opening += OnOpeningInternal;
            _vlcMediaPlayer.PausableChanged += OnPausableChangedInternal;
            _vlcMediaPlayer.Paused += OnPausedInternal;
            _vlcMediaPlayer.Playing += OnPlayingInternal;
            _vlcMediaPlayer.PositionChanged += OnPositionChangedInternal;
            _vlcMediaPlayer.ScrambledChanged += OnScrambledChangedInternal;
            _vlcMediaPlayer.SeekableChanged += OnSeekableChangedInternal;
            _vlcMediaPlayer.SnapshotTaken += OnSnapshotTakenInternal;
            _vlcMediaPlayer.Stopped += OnStoppedInternal;
            _vlcMediaPlayer.TimeChanged += OnTimeChangedInternal;
            _vlcMediaPlayer.TitleChanged += OnTitleChangedInternal;
            _vlcMediaPlayer.VideoOutChanged += OnVideoOutChangedInternal;
        }
