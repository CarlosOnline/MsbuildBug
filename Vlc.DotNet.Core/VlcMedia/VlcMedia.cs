...
namespace Vlc.DotNet.Core
{
    ...
    {
        private readonly VlcMediaPlayer.VlcMediaPlayer myVlcMediaPlayer;

        internal static Dictionary<VlcMediaPlayer.VlcMediaPlayer, List<VlcMedia>> LoadedMedias { get; }

        static VlcMedia()
        {
            LoadedMedias = new Dictionary<VlcMediaPlayer.VlcMediaPlayer, List<VlcMedia>>();
        }

        internal VlcMedia(VlcMediaPlayer.VlcMediaPlayer player, FileInfo file, params string[] options)
#if NET20
        ...
        internal VlcMedia(VlcMediaPlayer.VlcMediaPlayer player, Uri uri, params string[] options)
#if NET20
        ...
        internal VlcMedia(VlcMediaPlayer.VlcMediaPlayer player, VlcMediaInstance mediaInstance)
        {
        ...
        internal VlcMediaInstance MediaInstance { get; }
